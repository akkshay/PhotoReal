...
class UsersTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = userObjects[indexPath.row]["username"] as! String

        return cell
    }
    
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        selectedUsername = userObjects[indexPath.row]["username"] as! String
        self.performSegueWithIdentifier("toImagesVC", sender: self)
    }
    
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "toImagesVC" {
            let destVC = segue.destinationViewController as! ImagesTableViewController
            destVC.passedUsername = selectedUsername
        }
    }
